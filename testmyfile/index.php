...
<body>
    ...
    <div class="row">
      ...
      <div class="col-xl-2 col-xxl-2 col-md-3 col-sm-4 col-6 text-center mb-4">
        ...
        background: linear-gradient(to bottom, #30B5CE, #46A4D4, #5785E3); /* Gradient colors */
        position: relative; /* Enable positioning */
        overflow: hidden; /* Ensure the icon is clipped within the rounded border */
    }

    .avatar-title1 i {
        position: absolute; /* Position the icon absolutely */
        top: 50%; /* Align at the top */
        left: 50%; /* Align at the left */
        transform: translate(-50%, -50%); /* Center the icon */
        width: 60%; /* Set the width of the icon */
        height: 60%; /* Set the height of the icon */
        font-size: 18px; /* Increase the font size of the icon */
    ...
    <!-- end quick access -->
        ...
        <table class="table">
            ...
            <tbody>
                ...
                // Fetch files from database for the logged-in user
