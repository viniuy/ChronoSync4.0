...
<style>
            .iframe-container {
                ...
                width: 100%;
                height: 0;
                padding-bottom: 83.33%; /* Adjust this value according to the aspect ratio of your iframe content */
              }
        ...
        /* Style the iframe */
                ...
                <iframe id="myIframe"src="modules/Announcement/index.php" scrolling="no" style="  overflow: hidden;" ></iframe>
              </div>
              <script>
    // Wait for the iframe to load
    document.getElementById('myIframe').onload = function() {
        // Get the height of the content inside the iframe
        var iframeHeight = document.getElementById('myIframe').contentWindow.document.body.scrollHeight;
